...
Public Class EnAtencion
    ...
    Public Function BuscarAtencion(dni As String) As DataTable
        Dim cn As New Conexion
        Dim com As New SqlCommand("BuscarAtencionPorDni", cn.SqlCon1)
        Dim Res As SqlDataReader
        Dim tabla As New DataTable

        com.CommandType = CommandType.StoredProcedure
        com.Parameters.Add("@dni", SqlDbType.Char).Value = dni
        cn.SqlCon1.Open()
