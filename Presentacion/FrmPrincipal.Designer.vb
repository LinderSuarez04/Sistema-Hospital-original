...
Partial Class FrmPrincipal
    ...
    Private Sub InitializeComponent()
        ...
        ListarCitasToolStripMenuItem = New ToolStripMenuItem()
        ...
        MenuStrip1.Size = New Size(1432, 68)
        MenuStrip1.TabIndex = 0
        MenuStrip1.Text = "MenuStrip1"
        ' 
        ' CitasToolStripMenuItem
        ' 
        CitasToolStripMenuItem.DropDownItems.AddRange(New ToolStripItem() {RegistrarCitaToolStripMenuItem, ListarCitasToolStripMenuItem})
        ...
        ' 
        ' ListarCitasToolStripMenuItem
        ' 
        ListarCitasToolStripMenuItem.Name = "ListarCitasToolStripMenuItem"
        ListarCitasToolStripMenuItem.Size = New Size(233, 36)
        ListarCitasToolStripMenuItem.Text = "Listar Citas"
        ' 
        ...
        AgregarPacienteToolStripMenuItem.Size = New Size(263, 36)
        ...
        ListarPacientesToolStripMenuItem.Size = New Size(263, 36)
    ...
    Friend WithEvents ListarCitasToolStripMenuItem As ToolStripMenuItem
End Class
