...
Public Class Conexion
    ...
    Public Sub New()
        ...
        'cadena = "Data source=" & Me.server & ";Initial Catalog=" & Me.base & ";Integrated security =true;"

        'Primera opcion 



        cadena = "Data source=" & Me.server & ";Initial Catalog=" & Me.base & ";user id=" & Me.user & "password=" & Me.pass & ";"
